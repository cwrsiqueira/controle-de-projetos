...
$sql = $pdo->prepare("INSERT INTO projetos SET nome = :nome, descricao = :descricao, inicio = :inicio, etapa = :etapa, encerramento = :encerramento, monetizacao = :monetizacao, faturamento = :faturamento, obs = :obs");
